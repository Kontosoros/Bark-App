"""
URL configuration for bark_app project.
...
urlpatterns = [
    ...
    path("main/user/login/", TokenObtainPairView.as_view(), name="login"),
    path("main/user/register/", RegisterView.as_view(), name="register"),
